            ...
            <ol className="text-start">
                <li>Na potrzeby polityki prywatności poniższe pojęcia mają następujące znaczenie:
                    <ul>
                        ...
                        <li><strong>Cookies Administratora danych</strong> – oznacza Cookies zamieszczane przez Administratora danych, związane ze świadczeniem usług droga elektroniczną przez Administratora danych za pośrednictwem Serwisu.</li>
                        <li><strong>Cookies Zewnętrzne</strong> – oznacza Cookies zamieszczane przez partnerów Administratora danych, za pośrednictwem strony internetowej Serwisu.
                        <ol>
                            ...
                            <li><strong>Zbiór danych</strong> – oznacza zestaw danych o charakterze osobowym zbieranych przez Administratora Danych.</li>
                            <li><strong>Serwis</strong> – oznacza stronę internetową Administratora danych dostępną pod adresem: https://blueberrycakery.pl</li>
                ...
                <li>Administrator danych przetwarza dane osobowe Użytkowników w celu:
                    <ul>
                        ...
                        <li>wykonywania dopuszczalnych prawem działań marketingowych i promocyjnych.</li>
                    </ul>
                </li>
                <li>Administrator danych, w wykonaniu celów, o których mowa powyżej, może powierzyć dane osobowe Użytkowników operatorowi płatności internetowych, hostingodawcy, obsłudze księgowej oraz innym podmiotom, jeśli uzna to za zasadne i proporcjonalne w wykonaniu ww. celów.</li>
                <li>Dane Użytkowników mogą być udostępniane podmiotom uprawnionym do ich otrzymania na mocy obowiązujących przepisów prawa, w tym właściwym organom wymiaru sprawiedliwości.</li>
                <li>Administrator danych nie przetwarza żadnych wrażliwych danych osobowych Użytkowników.</li>
                <li>Użytkownicy mają prawo do:<ul>
                    <li>poprawiania, uzupełniania, uaktualnienia bądź sprostowania swoich danych osobowych,</li>
                    <li>żądania usunięcia swoich danych osobowych,</li>
                    <li>zgłoszenia sprzeciwu w zakresie przetwarzana swoich danych osobowych.</li>
                    <li>W powyższych celach Użytkownicy mogą przesłać stosowne żądanie w formie pisemnej bądź poprzez pocztę elektroniczną na adres Administratora danych wskazany w §1 ust. 1. niniejszej Polityki prywatności i Cookies.</li>
                    <li>Dane Użytkowników będą przechowywane przez okres nie dłuższy niż jest to konieczne do realizacji celu ich przetwarzania, a następnie zostaną usunięte.</li>
                    <li>Administrator danych wykorzystuje adresy IP zbierane w trakcie połączeń internetowych w celach technicznych, związanych z administracją Serwisu. Ponadto adresy IP służą do zbierania ogólnych, informacji statystycznych.</li>
                    ...
                    <li>Administrator danych wykorzystuje dwa typy plików Cookies:<ul>
                        ...
                        <li><strong>Cookies trwałe:</strong> są przechowywane na Urządzeniu Użytkownika i pozostają tam do momentu ich skasowania. Zakończenie sesji danej przeglądarki lub wyłączenie Urządzenia nie powoduje ich usunięcia z Urządzenia Użytkownika. Mechanizm Cookies trwałych nie pozwala na pobieranie jakichkolwiek danych osobowych ani żadnych informacji poufnych z Urządzenia Użytkownika.</li></ul></li>
                        ...
                        <li>Administrator danych wykorzystuje Cookies Administratora danych w następujących celach:
                            <ul>
                                <li>konfiguracji serwisu, czyli:<ol>
                                    <li>dostosowanie zawartości stron internetowych Serwisu do preferencji Użytkownika oraz optymalizacji korzystania ze stron internetowych Serwisu;</li>
                                    <li>rozpoznanie urządzenia Użytkownika Serwisu oraz jego lokalizację i odpowiednio wyświetlenia strony internetowej, dostosowanej do jego indywidualnych potrzeb;</li>
                                    <li>zapamiętanie ustawień wybranych przez Użytkownika,</li>
                                    <li>zapamiętanie historii odwiedzonych stron w serwisie w celu rekomendacji treści,</li>
                                    <li>zapamiętywanie zawartości koszyka Użytkownika,</li>
                                    <li>zapamiętywanie rozmiaru czcionki, wyglądu strony internetowej itp.</li></ol></li>
                                    <li>uwierzytelniania użytkownika w serwisie i zapewnienia sesji użytkownika w serwisie, czyli:<ol>
                                        <li>poprawnej konfiguracji wybranych funkcji Serwisu, umożliwiająca w szczególności weryfikację autentyczności sesji przeglądarki;</li>
                                        <li>optymalizacji i zwiększenia wydajności usług świadczonych przez Administratora danych;</li>
                                        <li>realizacji procesów niezbędnych dla pełnej funkcjonalności stron internetowych, czyli:
                                            <ul><li>realizacji procesów niezbędnych dla pełnej funkcjonalności stron internetowych, czyli:</li>
                                            <li>realizacji procesów niezbędnych dla pełnej funkcjonalności stron internetowych, czyli:</li>
                                            <li>analiz i badań oraz audytu oglądalności – tworzenia anonimowych statystyk, które pomagają zrozumieć, w jaki sposób Użytkownicy Serwisu korzystają ze stron internetowych Serwisu, co umożliwia ulepszanie ich struktury i zawartości.</li>
                                            <li>świadczenia usług reklamowych – czyli dostosowania prezentowanych za pośrednictwem Serwisu reklam usług i produktów firm trzecich;</li>
                                            <li>zapewnienia bezpieczeństwa i niezawodności Serwisu.</li></ul>
</li></ol></li>
                            </ul>
                        </li>
                        <li>Administrator usługi wykorzystuje Cookies Zewnętrzne w następujących celach:
                            <ul>
                                <li>prezentowania treści multimedialnych na stronach internetowych Serwisu, które są pobierane z zewnętrznego serwisu internetowego:
                                    <ol>
                                        <li>www.vimeo.com [administrator cookies: Vimeo, LLC. z siedzibą w USA]</li>
                                ...
                                <li>zbierania ogólnych i anonimowych danych statycznych za pośrednictwem narzędzi analitycznych:
                                    <ol>
                                        ...
                                        <li>Matomo (dawniej Piwik)  [administrator cookies: Matomo, Inc. z siedzibą w USA]</li>
                                        <li>prezentowania reklam dostosowanych do preferencji Użytkownika z wykorzystaniem narzędzia internetowej reklamy:<ul>
