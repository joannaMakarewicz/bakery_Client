  ...
  return (
    <>
      <ol className="text-start">
        <li>
          Strona www.chodznaciacho.pl działa na zasadach określonych w
          niniejszym Regulaminie.
        </li>
        <li>
          Regulamin określa rodzaje i zakres usług świadczonych drogą
          elektroniczną przez Stronę www.chodznaciacho.pl, zasady świadczenia
          tych usług, warunki zawierania i rozwiązywania umów o świadczenie
          usług drogą elektroniczną, a także tryb postępowania reklamacyjnego.
        </li>
        <li>
          Regulamin określa rodzaje i zakres usług świadczonych drogą
          elektroniczną przez Stronę www.chodznaciacho.pl, zasady świadczenia
        ...
        <li>
          ...
          korzystania z Usług Elektronicznych Strony www.chodznaciacho.pl,
      ...
      <h3 className="m-5">Definicje</h3>
      <ol className="text-start">
        <li>
          <strong>Formularz kontaktowy</strong> – formularz dostępny na Stronie
          www.chodznaciacho.pl umożliwiający Usługobiorcy bezpośredni kontakt z
          Usługodawcą.
        </li>
        <li>
          <strong>Regulamin</strong> – niniejszy regulamin Strony.
        </li>
        <li>
          <strong>Usługodawca</strong> – Magdalena Kalinowska wykonująca
          działalność gospodarczą pod firmą Chodź na ciacho Magdalena
          Kalinowska, adres: Leona Wyczółkowskiego 14A/3, 80-147 Gdańsk, NIP:
          7441723323, wpisaną do Centralnej Ewidencji i Informacji o
          Działalności Gospodarczej, adres poczty elektronicznej:
          chodznaciachogdansk@gmail.com, tel. 603909932.
        </li>
        <li>
        ...
        <li>
          ...
          elektroniczną przez Usługodawcę na rzecz Usługobiorcy za pośrednictwem
          Strony.
        </li>
      </ol>
      <h3 className="m-5">Rodzaj i zakres usług elektronicznych</h3>
      <ol className="text-start">
        <li>
          Usługodawca umożliwia za pośrednictwem Strony korzystanie z Usług
          Elektronicznych takich jak korzystanie z Formularza Kontaktowego.
      ...
      <h3 className="m-5">Tryb postępowania reklamacyjnego</h3>
      <ol className="text-start">
        <li>
          ...
          <ul>
            <li>
              ...
              poczty elektronicznej na adres: chodznaciachogdansk@gmail.com{" "}
            </li>
            <li>
      ...
      <h3 className="m-5">Własność intelektualna</h3>
      <ol className="text-start">
        <li>
          Wszystkie treści zamieszczone na stronie internetowej pod adresem
          www.chodznaciacho.pl korzystają z ochrony prawno autorskiej i są
          własnością Usługodawcy. Usługobiorca ponosi pełną odpowiedzialność za
          szkodę wyrządzoną Usługodawcy, będącą następstwem użycia jakiejkolwiek
          zawartości strony www.chodznaciacho.pl, bez zgody Usługodawcy.
        </li>
        <li>
          ...
          treść oraz zawartość strony www.chodznaciacho.pl stanowi naruszenie
          prawa autorskiego przysługującego Usługodawcy i skutkuje
          odpowiedzialnością cywilnoprawną oraz karną.
        </li>
      </ol>
      <h3 className="m-5">Postanowienia końcowe</h3>
      <ol className="text-start">
        <li>
